...
class Deposit:
    ...
    async def deposit(self, ctx):
        ...
        await self.bot.say(user.mention + "'s Deposit Address: `" + str(user_addy) + "`" + "\n\nRemember to use !balance to check your balance and not an explorer. The address balance and your actual balance are not always the same!\n\n:warning: DISCLAIMER: This is BETA software! Do not send large amounts of BWS! The developers are not reliable for any lost BWS! Do not store your coins on this server - they are not backed up and can be lost at any point! You have been warned! :warning:")
